    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-500">Register new claims, track hospital/workshop intimations & approval workflows</p>
        </div>
              ...
              {claimsList.map((cl) => (
                <tr key={cl.id} className="hover:bg-brand-50/30 transition">
                  ...
                  <td className="p-4 text-right">
                    <button 
                      onClick={() => alert(`Reviewing claim documents and inspection logs for ${cl.id}`)}
                      className="px-3 py-1.5 rounded-xl bg-brand-50 text-brand-700 font-bold hover:bg-brand-100 transition"
                    >
                      Review Claim
                    </button>
                  </td>
          ...
          <div className="bg-white rounded-2xl shadow-2xl border border-slate-200 w-full max-w-lg overflow-hidden">
            ...
            <form onSubmit={handleRegisterClaim} className="p-6 space-y-4">
              ...
              <div className="flex items-center justify-end space-x-3 pt-2">
                ...
                <button type="submit" className="px-5 py-2 rounded-xl bg-brand-600 text-white text-xs font-bold shadow">Submit Claim Intimation</button>
              </div>
            </form>
          </div>
        </div>
