...
export const Staff = () => {
  ...
  const [activeTab, setActiveTab] = useState('LEADERBOARD'); // LEADERBOARD, VAULT
  ...
  // New Staff & Credentials Form State
  ...
  const handleUpdateStaff = (e) => {
    ...
    alert(`Advisor ${editingStaff.name}'s login credentials and details updated successfully!`);
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-500">
            {isAdmin ? 'MD Control: Provision staff login accounts, view login credentials & set sales targets' : 'Advisor performance leaderboard & team targets'}
          </p>
        </div>
                    ...
                    {isAdmin && (
                      <>
                        <button 
                          ...
                          title="Edit Credentials & Target (MD)"
                        >
      ...
      {/* TAB 2: MD STAFF LOGIN CREDENTIALS DIRECTORY */}
                    ...
                    <td className="p-4 text-right">
                      <div className="flex items-center justify-end space-x-2">
                        <button 
                          ...
                          className="px-2.5 py-1.5 rounded-lg bg-slate-100 hover:bg-brand-100 text-slate-700 font-bold transition flex items-center space-x-1"
      ...
      {/* MD Provision New Staff & Login Credentials Modal */}
      {showAddStaffModal && (
      ...
      {/* Admin Edit Staff Credentials & Target Modal */}
      {editingStaff && (
        <div className="fixed inset-0 z-50 bg-slate-900/40 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-2xl border border-slate-200 w-full max-w-md overflow-hidden animate-in fade-in duration-150">
            <div className="px-6 py-4 bg-[#1E6091] text-white flex items-center justify-between">
              <h3 className="font-bold text-sm">MD Control: Edit Staff & Credentials ({editingStaff.name})</h3>
