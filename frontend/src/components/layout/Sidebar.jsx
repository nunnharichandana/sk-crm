  ...
  return (
    <aside className="w-64 bg-white border-r border-slate-200 min-h-[calc(100vh-61px)] flex flex-col justify-between py-4 shadow-sm">
      <div className="px-3 space-y-1">
        <div className="px-3 py-2 text-[11px] font-extrabold uppercase tracking-wider text-slate-400 flex items-center justify-between">
          <span>Role Navigation</span>
          <span className="badge badge-blue text-[9px]">{user?.roleDisplayName || currentRole}</span>
        </div>
